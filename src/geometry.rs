...
/// Дискретизация контура. 720 шагов (0.5°) достались от чистого вьюера STL,
/// но редактируемая деталь — это ещё и булевы: 720x8 давали 26 000
/// треугольников, и BSP-карман на такой сетке ложился. 180 шагов (2°) дают
/// хорду 0.01 мм на диске 140 мм — для FDM избыточно точно.
